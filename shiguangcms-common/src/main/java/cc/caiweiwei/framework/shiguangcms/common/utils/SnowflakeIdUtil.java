 ...
 *
 * @author CaiZhengwei
 * @since 2024/1/2 22:30
 */
public class SnowflakeIdUtil {

    private static SnowflakeIdGenerator snowflakeIdGenerator;

    public static void init(SnowflakeIdGenerator snowflakeIdGenerator) {
        SnowflakeIdUtil.snowflakeIdGenerator = snowflakeIdGenerator;
    }
    ...
    public static final class SnowflakeIdGenerator {
         ...
         * 初始时间戳(纪年)
         */
        private static final long INIT_EPOCH = 1420041600000L;
